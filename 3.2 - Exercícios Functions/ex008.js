...
//A função aceita 4 parâmetros (Nome do cliente, valor total da compra, um booleano que
// diz se é a primeira compra do cliente ou não, um booleando que diz se o cliente vai pagar a vista ou não)
